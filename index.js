...
const prototypeBook = Object.create(Book);

console.log("Завдання: 1 ==============================");

console.log(Book);

console.log(Object.getPrototypeOf(prototypeBook) === Book);
...
Object.defineProperty(ScienceBook, "bookInfo", {
  get() {
...
console.log(ScienceBook.bookInfo);
...
Textbook.read = function () {
  console.log(
    `Ви читаєте підручник "${this.title}" від ${this.author}. ${this.bookInfo}`
  );
};
